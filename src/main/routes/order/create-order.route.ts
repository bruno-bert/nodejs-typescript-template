...
import { makeCreateOrderFactory } from '@main/factories'
...
export default (router: Router): void => {
   ...
   *     responses:
   *       200:
   *         description: Returns the created record of Order
   *         content:
   *           application/json:
   *             schema:
   *                     type: object
   ...
   *                         description: The error message
   */
  router.post('/order', adaptRoute(makeCreateOrderFactory().makeController()))
}
